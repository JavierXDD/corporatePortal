...
<html>
  ...
  <body class="container-fluid" id="all">
    ...
    <!--路径导航-->
	<div class="top_back aboutback clearfix" id="secondbanner">
    	<div class="top_backin">
          <h2>${menulist[2].cName }</h2>
          <p>您当前的位置：</p>
          <ol class="breadcrumb">
            <li><a href='<c:url value="/index.jsp"></c:url>'>首页</a></li>
            <li>${menulist[2].cName }</li>            
            <li class="active">${about.aTitle }</li>
          </ol>
          <ul class="nav">
          <c:set var='tests' value="${cid}" scope="page"/> 
           <c:forEach items="${menulist }" var="child2"> 
           <c:if test="${child2.cId eq '4'}">
   ...
   <div class="middle_text">
   		...
   		<div class="articl">
            ...
            <div class="texttime">
            <p>${about.aTime } 来源：${about.aEditors.uName }</p>
            </div>
            <div class="textbody">
             ${about.aText }
            </div>
