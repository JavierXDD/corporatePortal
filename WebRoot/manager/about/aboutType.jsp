	...
	<div class="result-wrap">		
                <c:choose>
                	...
                	<div class="result-list">
                        <a href="${pageContext.request.contextPath }/manager/about/addAbout.jsp"><i class="icon-font"></i> 增加条目</a>
                    </div>
                        <br>
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
  							...
  							<td>${list.cName}</td>
  							<td><a  class="del" href='<c:url value="/AboutServlet?method=findAboutByCid&cid=${list.cId}"></c:url>'>进入</a></td>
  						</tr>
  						</c:forEach> 
                    </table><br>                   
</div>
