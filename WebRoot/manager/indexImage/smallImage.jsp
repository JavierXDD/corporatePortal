                        ...
                        <tbody id="tb">
                        	<c:forEach items="${MaxImageList}" var="list" >
                   			<tr class="${list.iId } abc">
                   				...
                   				<td><img width="355" height="175" src="${list.iValue }"/></td>
                   				<td>
                   				<c:if test="${list.iLocation eq 1 }">左上</c:if>
                   				<c:if test="${list.iLocation eq 2 }">右上</c:if>
                   				<c:if test="${list.iLocation eq 3 }">左下</c:if>
                   				<c:if test="${list.iLocation eq 4 }">右下</c:if>
                   				</td>
                   				<td><a names="${list.iName }" href="#" id="${list.iId }">重命名</a>  <a iid=${list.iId }>删除</a></td>
                   			</tr>
                   			</c:forEach>
  						</tbody>
                   	 </table>         
