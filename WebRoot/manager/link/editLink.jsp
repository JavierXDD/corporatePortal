    	...
    	<div class="crumb-wrap">
  		...
  		<div class="result-wrap">
            <div class="result-content">
                <form action="<c:url value='/LinkServlet?method=editLink&iId=${list.iId }'/>" method="POST" id="myform">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>友情网站名称</th>
                                <td>
                                    <input class="common-text required" id="title" name="iName" size="50" value="${list.iName }" type="text">
                                </td>
                            </tr>                        	
                            <tr>
                                <th><i class="require-red">*</i>链接地址</th>
                                <td>
                                    <input class="common-text required" id="addr" name="iValue" size="50" value="${list.iValue }" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th></th>
